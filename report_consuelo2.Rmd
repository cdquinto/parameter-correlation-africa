...
```{r plot3, echo=FALSE}
corr.mat2<-cor.matrix(variables=d(Asc_NAF,Asc_NEU,Asc_NCHB,daf,Log10_NAF,Log10_NEU,Log10_NCHB,NEU_AS,TEU_AS,TAF,Log10_NAT,Log10_NIBS,Log10_NMEX,TCEU_IBS,TCHB_NAT,TADM,PADM),
